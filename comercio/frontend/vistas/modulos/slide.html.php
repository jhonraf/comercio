	...
	<div class="row">
		...
		<ul>
			...
			<li>
				...
				<div class="slideOpciones slideOpcion1">
					...
					<div class="textosSlide" style="top: 20%; left: 10%; width: 40%">
						...
						<h1 style="color: #333">Vans</h1>

						<h2 style="color: #777">$ 1599.99 </h2>

						<h3 style="color: #888">Oferta: $1200.00 MNX</h3>
			...
			<li>
				...
				<div class="slideOpciones slideOpcion2">
					...
					<div class="textosSlide" style="top: 20%; right: 10%; width: 40%">
						...
						<h1 style="color: #333">Curso PHP</h1>

						<h2 style="color: #777">$ 2,700 MXN </h2>

						<h3 style="color: #888">-75% de descuento</h3>
			...
			<li>
				...
				<div class="slideOpciones slideOpcion3">
					...
					<div class="textosSlide" style="top: 15%; right: 15%; width: 40%">
						...
						<h1 style="color: #eee">Iphone 11</h1>

						<h2 style="color: #ccc">$ 11,000 MXN </h2>

						<h3 style="color: #aaa">-20% de descuento</h3>
			...
			<li>
				...
				<div class="slideOpciones slideOpcion4">

					<img class="imgProducto" src="" style="top: 5%; right:15%; width:25%;">

					<div class="textosSlide" style="top: 20%; left: 10%; width: 40%">

						<h1 style="color: #333">Informacion de producto</h1>

						<h2 style="color: #777">Precio</h2>

						<h3 style="color: #888">Oferta</h3>
